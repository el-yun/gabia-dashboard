			...
			<article id="contents">
				...
				<div class="panel">
					...
					<div class="panel-body">
						...
						<div class="w3-border">
							<div class="w3-bar w3-border-bottom w3-light-gray">
								<a class="w3-bar-item w3-button g-blue">What</a>
								<a class="w3-bar-item w3-button">Why</a>
								<a class="w3-bar-item w3-button">Where</a>
							</div>

							<div id="London" class="w3-padding-large city">
							...
							<div id="Paris" class="w3-padding-large city">
							...
							<div id="Tokyo" class="w3-padding-large city">
